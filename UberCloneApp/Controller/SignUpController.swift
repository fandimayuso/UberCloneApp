...
class SignUpController: UIViewController {
    ...
    private let fullNameTextField: UITextField = {
        return UITextField().textField(withPlacholder: "Full Name", isSecureTextEntry: false)
    }()
    ...
    private let accountTypeSegmentedControl: UISegmentedControl = {
        ...
        let titleTextAttributes1 = [NSAttributedString.Key.foregroundColor: UIColor(white: 1, alpha: 0.87)]
        let titleTextAttributes2 = [NSAttributedString.Key.foregroundColor: UIColor.black]
        sc.setTitleTextAttributes(titleTextAttributes1, for: .normal)
        sc.setTitleTextAttributes(titleTextAttributes2, for: .selected)
        return sc
    }()
