...
extension UIColor {
    ...
    static let outlineStrokeColor = UIColor.rgb(red: 234, green: 46, blue: 237)
...
extension UITextField {
    ...
    func textField(withPlacholder placeholder: String, isSecureTextEntry: Bool) -> UITextField {
        let tf = UITextField()
        tf.borderStyle = .none
